...
description: List initiative labels with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list initiative labels, initiative labels, initiative labels list
---
...
<CodePanel title="List initiative labels" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
