---
title: Bulk create work items
description: Bulk create up to 50 work items in one call with the Plane v2 REST API. Per-row results, atomic all_or_none mode, OAuth scopes, error codes, and code examples.
keywords: plane api v2, bulk-create work items, bulk write, all_or_none, partial success, per-row results
---
...
<div class="api-endpoint-badge">
  ...
  <span class="path">/api/v2/workspaces/{slug}/projects/{project_id}/work-items/bulk-create/</span>
</div>

<div class="api-two-column">
<div class="api-left">

Create up to **50** work items in one request. Each row is validated and written exactly as [Create a work item](/api-reference/v2/work-items/create-work-item) would, so every business rule and permission check still applies per row.
...
The work items to create — each entry takes the same body as [Create a work item](/api-reference/v2/work-items/create-work-item). Between 1 and **50** per call.
...
<CodePanel title="Bulk create work items" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
