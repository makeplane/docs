---
title: List webhooks
description: List webhooks with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list webhooks, webhooks, webhooks list
---
...
<CodePanel title="List webhooks" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
