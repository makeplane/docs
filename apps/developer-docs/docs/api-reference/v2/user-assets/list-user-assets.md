...
description: List user assets with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list user assets, user assets, user assets list
---
...
<CodePanel title="List user assets" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
