...
description: List workspace views with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list workspace views, workspace views, workspace views list
---
...
<CodePanel title="List workspace views" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
