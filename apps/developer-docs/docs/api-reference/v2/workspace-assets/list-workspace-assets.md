---
title: List workspace assets
description: List workspace assets with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list workspace assets, workspace assets, assets list
---
...
<CodePanel title="List workspace assets" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
