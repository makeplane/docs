...
description: Bulk delete up to 50 milestones in one call with the Plane v2 REST API. Per-row results, atomic all_or_none mode, OAuth scopes, error codes, and code examples.
keywords: plane api v2, bulk-delete milestones, bulk write, all_or_none, partial success, per-row results
---
...
<div class="api-endpoint-badge">
  ...
  <span class="path">/api/v2/workspaces/{slug}/projects/{project_id}/milestones/bulk-delete/</span>
</div>

<div class="api-two-column">
<div class="api-left">

Delete up to **50** milestones in one request. Each row goes through the same path as a single [Delete a milestone](/api-reference/v2/milestones/delete-milestone), so delete guards still apply per row.
...
<CodePanel title="Bulk delete milestones" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
