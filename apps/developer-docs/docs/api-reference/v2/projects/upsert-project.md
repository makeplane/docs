---
title: Upsert a project
description: Upsert a project with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, upsert a project, projects, projects upsert
---
...
<div class="api-endpoint-badge">
  ...
  <span class="path">/api/v2/workspaces/{slug}/projects/upsert/</span>
</div>

<div class="api-two-column">
<div class="api-left">

Projects are the main container for work items in a workspace. Create a project, or update the existing one that carries the same `(external_source, external_id)` pair.
...
<CodePanel title="Upsert a project" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>

```bash
curl -X POST \
  "https://api.plane.so/api/v2/workspaces/my-team/projects/upsert/" \
...
```javascript
const response = await fetch("https://api.plane.so/api/v2/workspaces/my-team/projects/upsert/", {
  method: "POST",
  headers: {
