...
description: List workspace pages with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list workspace pages, workspace pages, workspace pages list
---
...
<CodePanel title="List workspace pages" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
