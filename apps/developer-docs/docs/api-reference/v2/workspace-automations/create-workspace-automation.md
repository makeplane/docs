...
description: Create a workspace automation with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, create a workspace automation, workspace automations, workspace automations create
---
...
<CodePanel title="Create a workspace automation" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
