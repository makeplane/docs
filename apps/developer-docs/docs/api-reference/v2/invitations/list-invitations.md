...
description: List invitations with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list invitations, invitations, members list
---
...
<ApiParam name="accepted" type="boolean" :required="false">
...
<CodePanel title="List invitations" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
