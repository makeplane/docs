---
title: Bulk create comments
description: Bulk create up to 50 comments in one call with the Plane v2 REST API. Per-row results, atomic all_or_none mode, OAuth scopes, error codes, and code examples.
keywords: plane api v2, bulk-create comments, bulk write, all_or_none, partial success, per-row results
---
...
<div class="api-endpoint-badge">
  ...
  <span class="path">/api/v2/workspaces/{slug}/projects/{project_id}/work-items/{work_item_id}/comments/bulk-create/</span>
</div>

<div class="api-two-column">
<div class="api-left">

Create up to **50** comments in one request. Each row is validated and written exactly as [Create a comment](/api-reference/v2/work-item-comments/create-comment) would, so every business rule and permission check still applies per row.
...
The comments to create — each entry takes the same body as [Create a comment](/api-reference/v2/work-item-comments/create-comment). Between 1 and **50** per call.
...
<CodePanel title="Bulk create comments" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
