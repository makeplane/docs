...
description: Bulk delete up to 50 comments in one call with the Plane v2 REST API. Per-row results, atomic all_or_none mode, OAuth scopes, error codes, and code examples.
keywords: plane api v2, bulk-delete comments, bulk write, all_or_none, partial success, per-row results
---
...
<div class="api-endpoint-badge">
  ...
  <span class="path">/api/v2/workspaces/{slug}/projects/{project_id}/work-items/{work_item_id}/comments/bulk-delete/</span>
</div>

<div class="api-two-column">
<div class="api-left">

Delete up to **50** comments in one request. Each row goes through the same path as a single [Delete a comment](/api-reference/v2/work-item-comments/delete-comment), so delete guards still apply per row.
...
<CodePanel title="Bulk delete comments" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>

```bash
curl -X POST \
  "https://api.plane.so/api/v2/workspaces/my-team/projects/4af68566-94a4-4eb3-94aa-50dc9427067b/work-items/b7e42a19-3c5d-4f80-9a26-8d1c0f4e7b53/comments/bulk-delete/" \
