---
title: Create a initiative
description: Create a initiative with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, create a initiative, initiatives, initiatives create
---
...
<CodePanel title="Create a initiative" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
