...
3. Click **Connect** in the GitLab section, which will redirect you to GitLab for authentication.
   ::: info
   ...
   :::
4. Once connected, your GitLab account will be listed in Plane.
