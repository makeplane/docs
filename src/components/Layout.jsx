...
const navigation = [
  ...
  },
  {
    title: 'Integrations',
    links: [
      { title: 'About', href: '/integrations/about' },
  ...
  },
  {
    title: 'Importers',
    links: [
      { title: 'GitHub', href: '/importers/github' },
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-grow basis-0 items-center">
        <Link href="/" aria-label="Home page">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden text-4xl font-medium logo-text lg:block">
              Plane
            </div>
          </div>
        </Link>
      ...
      <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 md:flex-grow">
        <Link href="https://github.com/makeplane/plane" className="group" aria-label="GitHub">
          <DiscordIcon className="h-6 w-6 fill-slate-400 group-hover:fill-slate-500 dark:group-hover:fill-slate-300" />
        </Link>
        <Link href="https://discord.com/invite/A92xrEGCge" className="group" aria-label="GitHub">
