...
Plane Cloud is our hosted solution that enables you to start using Plane effortlessly. To begin using Plane Cloud, all you need to do is sign up for an free account and follow the straightforward steps outlined.

### Plane Self-hosted

Plane is open-source'd under Apache-2.0. You can self-host Plane on your own server using Docker. For detailed instructions on self-hosting, please refer to our [Self-Hosting guide](/self-hosting).
