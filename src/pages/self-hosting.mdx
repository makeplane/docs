...
<br/>
# Install with Docker
<Note>We are currently upgrading the configuration for the Plane Docker image, and as a result, some issues may arise. In the meantime, we highly recommend using docker-compose to self-host Plane.</Note>
