...
:::warning
Update your CLI with the command `sudo prime-cli update-cli` before you download any Plane updates. The latest version of the CLI ensures your Plane upgrades happen smoothly.
:::
...
For more advanced admins that want greater control over their instance, the list of additional commands available on Prime CLI follow.
    - `configure` 
        ...
        <details>
            <summary>Steps to configure your instance</summary>
            - `Listening port`
