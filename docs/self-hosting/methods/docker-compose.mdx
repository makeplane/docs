   ...
   ### Installation
      ...
      10. Enter `2` as input to start the services.
         You will something like this:  
            ![Downloading docker images](/img/docker-compose/download-docker.png)
            ...
            ![Downloading completed](/img/docker-compose/download-complete.png)
      ...
      #### Stop server
         ...
         ![Stop Services](/img/docker-compose/stopped-docker.png)
      ...
      #### Restart server
         ...
         ![Restart Services](/img/docker-compose/restart-docker.png)