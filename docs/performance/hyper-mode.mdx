---
title: Hyper Mode
description: Improve performance by storing workspace data locally. Enable faster loading times, manage sync settings, and troubleshoot potential data inconsistencies.
---
