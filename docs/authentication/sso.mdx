...
**Session management**  
Users stay signed in based on your IdP's session settings. When they sign out of your IdP, they're also signed out of Plane (if the logout URL is configured).
