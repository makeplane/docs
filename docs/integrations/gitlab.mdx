...
title: GitLab
hide_title: true
description: Integrate Plane with GitLab and Self-managed GitLab to synchronize issues and pull requests. Connect repositories to projects for bidirectional updates and seamless workflows.
---
