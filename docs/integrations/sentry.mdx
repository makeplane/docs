...
3. [Set up Sentry alerts](/integrations/sentry#set-up-sentry-alerts)
4. [Link Sentry issues to Plane work items](/integrations/sentry#link-sentry-issues-to-plane-work-items)
