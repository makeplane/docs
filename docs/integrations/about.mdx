...
<CardGroup cols={2}>
  ...
  title="Sentry"
  svg={
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="25px" viewBox="0 -14.5 256 256" version="1.1" preserveAspectRatio="xMidYMid" aria-labelledby="sentry">
    <g>
