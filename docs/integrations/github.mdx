...
3. [Add repository mappings](#configure-pr-state-automations)
...
The lifecycle of a pull request can be [mapped](#configure-pr-state-automations) to workflow states in Plane. The following PR states are available for mapping:
