...
All data is encrypted in transit and at rest, and you can disconnect the integration at any time from your [Workspace Settings](/core-concepts/workspaces/overview#workspace-settings) or [Profile settings](/core-concepts/account/settings).
