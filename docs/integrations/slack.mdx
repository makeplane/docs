...
This is perfect for situations where someone logs an work item in Plane but the conversation about it happens in Slack. Just link them up and avoid duplication.
