...
Need to create a new project, issue or page? Tap the + Create button. 
    ...
    - **New project**  
        Add the project details such as icon, name, description and the lead. Mark it as public or private. Hit the **Create** button.
...
- **Create** <br/>
    Similar to the Create button on the main navigation bar, but you can only create new issues and pages here. 
