---
title: Home and navigation in the Plane mobile app
description: Get around the Plane mobile app with Home, Inbox, Search, Create, Catch-up, stickies, favorites, and recents.
---

# Home & navigation

Home is your starting point in the Plane mobile app. It pulls together what needs your attention and gives you a quick path to everything else.

## The navigation bar

The bar at the bottom of the screen has three destinations, with a **Create** button in the center:
...
The dashboard is organized into sections you can scroll through:
...
<!-- TODO screenshot: the Home dashboard showing Catch-up, stickies, favorites, and recents. Upload as media.docs.plane.so/mobile/app-home.webp -->
...
- Use **Mark all as read** to clear everything at once.

When there is nothing left, you see a "You have caught up" message.

::: info
Catch-up is available on recent app versions and, for self-hosted instances, from `v1.15.0`.
:::

## Stickies

Stickies are lightweight, colorful notes for quick thoughts, reminders, and brainstorms. They live at the workspace level and appear on Home.

- **Create a sticky** from the **Create** button, or from the stickies section on Home. New stickies get a color you can change.
- **Edit** a sticky's content with the rich text editor.
- **Change the color** to organize them visually.
- **Make a copy** to duplicate a sticky.
- **Select multiple** stickies to delete them in one action.
- **Delete** removes a sticky permanently.

::: info
Stickies are available from self-hosted `v1.9.0`.
:::
...
::: info
Enhanced search is available from self-hosted `v1.14.0`. On earlier versions, search covers a smaller set of content.
:::

<!-- TODO screenshot: global search with type filters and recent searches. Upload as media.docs.plane.so/mobile/app-search.webp -->
...
- **Page** in a project you choose.
- **Work item** in a project you choose.

What appears in this menu depends on your role and your plan. For details on creating and editing work items, see [Work items](/devices/mobile/work-items).

<!-- TODO screenshot: the Create menu showing Sticky, Project, Page, and Work item. Upload as media.docs.plane.so/mobile/app-create-menu.webp -->
