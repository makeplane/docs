...
1. Navigate to [Workspace Settings](https://docs.plane.so/core-concepts/workspaces/overview#workspace-settings).
    ![Create page template](https://media.docs.plane.so/templates/create-page-templates.webp#center)
...
5. Fill in the template details:
    ![Page template details](https://media.docs.plane.so/templates/page-template-details.webp#center)
...
![Use Template when creating pages](https://media.docs.plane.so/templates/use-template-pages.webp#center)
...
![Use template in settings](https://media.docs.plane.so/templates/use-page-template-settings.webp#center)
