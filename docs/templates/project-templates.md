...
# Create projects faster with templates <Badge type="tip" text="Business" />
...
5. Fill in the template details:
   ...
   ![Project template details](https://media.docs.plane.so/templates/project-template-details.webp#hero)
...
![Use Template when creating projects](https://media.docs.plane.so/templates/use-template-projects.webp#hero)
...
![Use template in workspace settings](https://media.docs.plane.so/templates/use-template.webp#hero)
