...
hide_title: true
description: Ceate and use Project Templates to standardize projects, save setup time, and ensure consistency across your workspace with predefined settings.
---
...
:::info
[Work Item Templates](/templates/work-item-templates) are also available to standardize tasks within your projects. Page Templates are on our roadmap and coming soon.
:::