...
![Analytics Overview](https://media.docs.plane.so/analytics/analytics-overview.webp#hero)
...
![Analytics Work Items](https://media.docs.plane.so/analytics/work-item-analytics.webp#hero)
...
![Customized insights](https://media.docs.plane.so/analytics/customized-insights.webp#hero)
