...
![view](https://media.docs.plane.so/views/views-overview.png)
## View types
...
![Create view](https://media.docs.plane.so/views/create-view-modal.png)
...
![Create view from existing](https://media.docs.plane.so/views/view-create-from-existing.png)
