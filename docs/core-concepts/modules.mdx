...
![Create module](https://media.docs.plane.so/modules/create-module.png)
...
![Add issues to module](https://media.docs.plane.so/modules/add-issues-to-module.png)
...
![Module layout](https://media.docs.plane.so/modules/module-gantt.png)
...
![Module progress](https://media.docs.plane.so/modules/module-progress.png)
