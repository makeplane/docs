...
- Add new or existing work items directly from the Module page.
    ![Add work items to module](https://media.docs.plane.so/modules/add-issues-to-module.webp#center)

- Assign multiple Modules to an work item from its properties. For instance, an work item can belong to both a Feature module and a Release module simultaneously.
    ![Work item module property](https://media.docs.plane.so/modules/issue-module-property.webp#center)
