...
![Create module](/img/modules/create-module.png)
...
![Add issues to module](/img/modules/add-issues-to-module.png)
...
![Module layout](/img/modules/module-gantt.png)
...
![Module progress](/img/modules/module-progress.png)
