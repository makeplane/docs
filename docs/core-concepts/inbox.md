...
![Inbox mentions](https://media.docs.plane.so/inbox/inbox-mentions.webp#hero)
...
![Stacked notifications](https://media.docs.plane.so/inbox/stacked-notifications.webp#hero)
