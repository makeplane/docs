...
Pages in Plane let you easily capture and organize project-related information, much like docs. Whether you’re documenting meeting notes or detailing technical or product requirements, Pages allow you to collaborate directly within the context of your project—no need for external tools.
...
Plane allows you to use Markdown in Pages, making it easy to format content quickly with familiar Markdown syntax. You can create headings, lists, links, and other common formats right in your page without switching to a separate editor. Markdown is ideal for team members who prefer using text shortcuts to organize information faster.
...
:::caution
Keep in mind that you can only restore previous versions within a two-day period in the Pro plan.
:::
...
- **Export function fails to download a document**  
Ensure pop-up blockers are disabled and browser permissions allow downloads.

- **Revisions are not appearing in the Info panel**  
Ensure that at least one page update has occurred. Check the version history to confirm the system logged any changes.
