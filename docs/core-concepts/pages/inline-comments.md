...
<div class="tag-wrapper">
  <h1>Add inline comments in pages</h1>
...
![Inline comments](https://media.docs.plane.so/pages/inline-comment.webp#hero)
...
![Add inline comment](https://media.docs.plane.so/pages/add-inline-comment.webp#hero)
