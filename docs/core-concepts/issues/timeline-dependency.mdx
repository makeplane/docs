...
![Timeline dependencies](https://media.docs.plane.so/issues/timeline-dependencies.webp#center)
...
- **Finish-to-Start (FS)**   
  ...
  ![Finish to start](https://media.docs.plane.so/issues/finish-to-start.webp#center)
...
- **Start-to-Start (SS)**  
  ...
  ![Start to start](https://media.docs.plane.so/issues/start-to-start.webp#center)
...
- **Finish-to-Finish (FF)**  
  ...
  ![Finish to finish](https://media.docs.plane.so/issues/finish-to-finish.webp#center)
...
![Dependency relations](https://media.docs.plane.so/issues/dependency-relations.webp#center)
