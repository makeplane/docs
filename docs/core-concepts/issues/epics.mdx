...
![Add work items to Epic](https://media.docs.plane.so/epics/add-issues.webp#center)
...
For each work item, you can assign or change an work item's Epic directly in the **Parent** property.
