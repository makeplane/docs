...
| -------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| Title          | Title of the work item or a summary of the work item. This is the only mandatory field to create an work item.                          |
...
| Assignees      | Members responsible to work on the work item.                                                                                    |
