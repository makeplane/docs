...
If the Project Admin sets the **Timezone** in [Project settings](/core-concepts/projects/overview#configure-project-settings), the Cycle schedules (start and end) will align with it. However, Members will view Cycles starting and stopping based on the timezone set in their [profile settings](/core-concepts/account/settings#timezone-and-language).
:::
...
![End Cycle](https://media.docs.plane.so/cycles/end-cycle.webp#hero-tr)
...
![Cycle progress charts](https://media.docs.plane.so/cycles/cycle-progress-charts.webp#hero)
...
<div class="tag-wrapper">
  <h2>Active cycles across projects</h2>
  <Tags :tags='[{ name: "Pro", link: "https://plane.so/pricing", additionalClass: "pro" }]' />
</div>
...
![Active cycles](https://media.docs.plane.so/cycles/active-cycles-projects.webp#hero)
