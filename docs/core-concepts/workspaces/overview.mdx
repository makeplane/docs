...
If you are a first-time user who has signed up for Plane, you will create a new workspace for your team during the onboarding process.
 ![Create workspace](https://media.docs.plane.so/workspaces/create-workspace.png)
...
![workspace-settings](https://media.docs.plane.so/workspaces/workspace-settings.png)
