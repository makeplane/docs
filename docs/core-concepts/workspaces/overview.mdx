...
If you are a first-time user who has signed up for Plane, you will create a new workspace for your team during the onboarding process.
 ![Create workspace](/img/workspaces/create-workspace.png)
...
A project allows you to create issues, assign tasks to members, and advance in Plane. Projects serve as the cornerstone for all activities within the product. If you envision your organization as NASA, each mission can be likened to a project. [Learn more here.](/core-concepts/projects)
...
![workspace-settings](/img/workspaces/workspace-settings.png)
