...
![Project state](https://media.docs.plane.so/projects/project-states.png)
...
![Project state](https://media.docs.plane.so/projects/project-new-state.png)
...
![Project labels](https://media.docs.plane.so/projects/project-labels.png)
...
![Project archive automation](https://media.docs.plane.so/projects/project-automations.png)
...
![Project close automation](https://media.docs.plane.so/projects/project-close-automation.png)
