...
![Project state](https://media.docs.plane.so/projects/issue-states.webp#center)
...
![Project state](https://media.docs.plane.so/projects/project-new-state.webp#center)
