...
![](https://media.docs.plane.so/power-k/power-k1.png)
...
### Search
 ...
 ![](https://media.docs.plane.so/power-k/power-k2.png)
...
![](https://media.docs.plane.so/power-k/power-k3.png)
...
### Quick access
 - **Workspace and preference settings**
   ...
   ![](https://media.docs.plane.so/power-k/power-k4.png)

 - Keyboard shortcuts
   Get to your list of keyboard shortcuts with the Power K menu in two steps.

   ![](https://media.docs.plane.so/power-k/power-k5.png)
...
### Create
 ...
 - Press ⌘ + K on an issue page to change states, priority, assignments or just to copy issue links.
   ...
   ![](https://media.docs.plane.so/power-k/power-k6.png)
