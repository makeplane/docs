...
Just head to the **Billing and plans** section in your [Workspace settings](/core-concepts/workspaces/overview#access-workspace-settings) and click the **Start free trial** button.
