...
**Removing members doesn't automatically remove seats. You must remove seats separately to affect your billing.** See [Add or remove paid users](/workspaces-and-users/upgrade-plan#add-or-remove-paid-users) for more details.
