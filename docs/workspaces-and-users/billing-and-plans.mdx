...
## Free trial
If you're using Plane Cloud, you can start a 14-day free trial for the Pro plan. 

:::warning[self-hosted]
Free trials are not available for self-hosted paid plans.
:::

Just head to the **Billing and plans** section in your [Workspace settings](/core-concepts/workspaces/overview#workspace-settings) and click the **Start free trial** button in the Pro plan.

![Free trial](https://media.docs.plane.so/activate-license/free-trial.webp#center)

During the trial, you'll have full access to all Pro plan features, allowing you to explore and evaluate them before committing to a subscription.

If you decide the Pro plan isn’t the right fit, you can cancel the trial anytime before it ends. To do this, click the **Upgrade** button in the **Pro** card, then select **Cancel subscription** on the Stripe page. Once canceled, your workspace will revert to the free plan without any charges.
