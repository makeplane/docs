...
4. If you’re switching machines or reinstalling the Commercial edition, make sure to back up your data and restore it to the new instance. For more information, see [Move to another server](https://developers.plane.so/self-hosting/manage/migrate-plane).
