...
![Create cycle dialog](https://media.docs.plane.so/tutorials/create-cycle.webp#center)
...
![Cycles overview](https://media.docs.plane.so/tutorials/cycles-interface.webp#center)
...
![Cycle detail view](https://media.docs.plane.so/tutorials/add-work-items-to-cycle.webp#center)
...
![Cycle progress tracking](https://media.docs.plane.so/tutorials/view-cycle-progress.webp#center)
