...
![Page settings menu](https://media.docs.plane.so/quickstart/page-options.webp#center)
...
Ready to advance your Pages skills?
- [Master all editor blocks and advanced formatting
