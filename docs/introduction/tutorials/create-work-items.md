...
![Create work items](https://media.docs.plane.so/tutorials/create-work-items.webp#hero)
...
![View and update work items](https://media.docs.plane.so/tutorials/view-and-update-work-items.webp#hero)
...
5. **Move work to completion**
   ...
   ![Switch to board layout](https://media.docs.plane.so/tutorials/switch-to-board-layout.webp#hero)
...
You now understand the complete work item lifecycle and can effectively track work in Plane.
You're ready to:
