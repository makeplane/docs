...
![Workspace switcher](https://media.docs.plane.so/tutorials/workspace-switcher.webp#center)
...
![Workspace creation form](https://media.docs.plane.so/tutorials/workspace-creation-form.webp#center)
...
![Workspace Home](https://media.docs.plane.so/tutorials/workspace-home.webp#center)
...
![Workspace settings](https://media.docs.plane.so/tutorials/workspace-settings.webp#center)
