...
![Switcher invite members](https://media.docs.plane.so/tutorials/switcher-invite-members.webp#center)

1. Click on your workspace name in the top-left corner.
2. Next to your current workspace, click **Invite members**.

**From workspace settings**  
![Workspace members](https://media.docs.plane.so/tutorials/workspace-members.webp#center)
...
![Add members](https://media.docs.plane.so/tutorials/add-members.webp#center)
...
![Remove members](https://media.docs.plane.so/tutorials/remove-member.webp#center)
