...
8. **Configure Jira**:  
    1. Choose the workspace and project in Jira from where you want to import data.
...
12. **Summary**:   
    Review the mappings and make any changes if needed.  Click **Go Back** to adjust, or click **Confirm** to start the migration.
