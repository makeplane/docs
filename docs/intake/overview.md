...
Intake creates a buffer between external submissions and your active project work. Items submitted through any intake channel land in a _Triage_ state where your team can review, add context, and decide whether to accept them into your workflow or decline them.
