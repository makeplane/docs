...
6. Match your ClickUp priorities (Urgent, High, Normal, Low) to Plane priorities using the dropdown menus. This keeps your task prioritization consistent after migration.

7. Review the mappings and make any changes if needed. Click **Back** to adjust.

8. You can check "Skip importing User data" if you don't want to migrate user information and manually add them later.
    :::warning
