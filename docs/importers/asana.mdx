...
With the Asana importer, you can easily import work items, states, labels, priorities and user data from Asana to Plane and continue managing your existing projects.

## Import from Asana
> **Role**: Workspace admins

:::tip
To import work item types from Asana, make sure the [Work item types](/core-concepts/issues/issue-types) feature is enabled in your Plane workspace.
:::
