...
![](https://media.docs.plane.so/github-imp/workspace-settings.png)
...
![integration](https://media.docs.plane.so/github-imp/integration.png)
...
![configure](https://media.docs.plane.so/github-imp/configure.png)
...
![sync](https://media.docs.plane.so/github-imp/sync.png)
...
![verify](https://media.docs.plane.so/github-imp/verify.png)
...
![map](https://media.docs.plane.so/github-imp/map.png)
...
![confirm](https://media.docs.plane.so/github-imp/confirm.png)

![import](https://media.docs.plane.so/github-imp/import.png)
...
![merge](https://media.docs.plane.so/github-imp/merge.png)

All the properties mentioned above, including comments, will be imported.

![comments](https://media.docs.plane.so/github-imp/comments.png)
