...
<Card
  title="Linear"
  svg={
    <svg height="21" viewBox="0 0 500 100" fill="currentColor" size="16" color="currentColor" aria-label="Linear">
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
...
<Card
  title="Asana"
  svg={
    <svg width="112" height="22" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-labelledby="asana">
      <path
