...
export default defineConfig({
  ...
  head: [
    ...
    ['script', {}, `window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag('js',new Date());gtag('config','G-G578SD4VZD',{anonymize_ip:true});`],
    ...
    // Font preloads
    ['link', { rel: 'preload', href: '/fonts/Satoshi/Satoshi-Variable.ttf', as: 'font', type: 'font/ttf', crossorigin: 'anonymous' }],
    ['link', { rel: 'preload', href: '/fonts/IBM/IBMPlexMono-Light.ttf', as: 'font', type: 'font/ttf', crossorigin: 'anonymous' }],
    ['link', { rel: 'preload', href: '/fonts/IBM/IBMPlexMono-Regular.ttf', as: 'font', type: 'font/ttf', crossorigin: 'anonymous' }],
    ['link', { rel: 'preload', href: '/fonts/IBM/IBMPlexMono-SemiBold.ttf', as: 'font', type: 'font/ttf', crossorigin: 'anonymous' }],
    ['link', { rel: 'preload', href: '/fonts/IBM/IBMPlexMono-Bold.ttf', as: 'font', type: 'font/ttf', crossorigin: 'anonymous' }],
    ...
    ['meta', { name: 'keywords', content: 'project management, issue tracking, sprint management, agile, scrum, create projects, track sprints' }],
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Self-hosted authentication', link: 'https://developers.plane.so/self-hosting/govern/authentication' },
            ],
          },
          {
