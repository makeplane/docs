...
To illustrate with a real workflow - managing a product launch:
...
| Plan | Monthly credits per user | Rollover period | Credit pooling |
| --- | --- | --- | --- |
| **Free** | 500 | No rollover | Individual only |
| **Pro** | 1,000 | 1 month | Workspace-wide |
| **Business** | 2,000 | 3 months | Workspace-wide |
| **Enterprise** | Flexible allocation | Up to 12 months | Workspace-wide |
...
**Free plan** credits don't roll over because they're designed for individuals exploring Plane AI. The 500 monthly credits reset each month.
...
| Scale ack | 5,000 | $9.00 | Moderate automation use |
