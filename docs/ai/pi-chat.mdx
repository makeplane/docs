...
![Pi chat sidebar](https://media.docs.plane.so/pi-chat/pi-chat-sidebar.webp#center)
...
![Pi chat project](https://media.docs.plane.so/pi-chat/pi-chat-project.webp#center)
...
![Pi chat mentions](https://media.docs.plane.so/pi-chat/pi-chat-mentions.webp#center)
