...
#### Archived estimates
In older versions we supported adding different estimate systems, to help you switch between using different estimate values for your project easily. We have now changed this behavior to only have a single estimate system for your project. In-active estimate systems in the older version are now archived.
