...
3. Switch on the toggle button for the **Intake** feature to enable it on the project. 
    ...
    <Frame>![enable-intake-feature](/images/inbox/enable-intake-feature.webp)</Frame>
...
<Frame>![create-issue-intake](/images/inbox/create-issue-intake.webp)</Frame>
3. Enter the required details and click the **Create Issue** button.

    <Frame>![enter-issue-details](/images/inbox/enter-issue-details.webp)</Frame>
...
### Accept issue
    ...
    <Frame>![accept-intake-issue](/images/inbox/accept-intake-issue.webp)</Frame>
...
An issue can be snoozed to review it at a later time.
    ...
    <Frame>![snooze-intake-issue](/images/inbox/snooze-intake-issue.webp)</Frame>
...
4. Select an issue in the project that is a duplicate of the Intake issue.
    ...
    <Frame>![mark-duplicate-intake-issues](/images/inbox/mark-duplicate-intake-issues.webp)</Frame>
