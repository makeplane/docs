...
| ssl.server | [https://acme-v02.api.letsencrypt.org/directory](https://acme-v02.api.letsencrypt.org/directory) |  | (Yes, if createIssuer = true)Lets Encrypt SSL Generation API.  Staging: [https://acme-staging-v02.api.letsencrypt.org/directory](https://acme-staging-v02.api.letsencrypt.org/directory) |
| ssl.email | [plane-admin@example.com](plane-admin@example.com) |  | (Yes, if createIssuer = true) Required by Let's Encrypt. Change to a valid email id |
