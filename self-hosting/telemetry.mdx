...
We don’t collect any other usernames, emails or the issue titles, descriptions details of any kind, or any personally identifiable information (PII). This is helpful for us to communicate in crucial scenarios.
...
1. Login to the god-mode..
2. Click General settings
3. Toggle the Telemetry option.
