...
6. Click **Accept** to allow Plane access to your Atlassian account. If you have multiple workspaces with the same account, select the one from which you want to import the data to Plane in the **Use app on** list.
    <Frame>![Authorise Plane](/images/importers/jira/authorize-plane.webp)</Frame>
7. **Configure Plane**:   
...
14. Navigate to **Issues** in your project on the sidebar to verify that the data import is successful. 
     <Frame>![Verify import](/images/importers/jira/verify-import.webp)</Frame>
...
3. Click the **Re run** button on the project you want to sync.
    <Frame>![Sync Jira](/images/importers/jira/rerun-import.webp)</Frame>
