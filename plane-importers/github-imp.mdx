---
title: Import your GitHub repository issues to Plane
sidebarTitle: GitHub
---
...
All the importers are managed under Workspace settings, to use the GitHub importer the first step is to navigate to `Workspace Settings > Integrations`.
