...
## Quickstart
With Plane one the easiest way to get started is by using our 1-click-deploy command from your CLI. Alternatively you can choose to get started with kuberenetes(helm-chart).
